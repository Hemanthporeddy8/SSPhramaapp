...
;
const metadata = {
    title: 'PathAssist - Your Health Journey, Simplified',
    description: 'PathAssist provides seamless appointment scheduling, status tracking, and report access for pathology labs.'
};
